                  ...
                  onPressed: () async {
                    try {
                      ...
                      ScaffoldMessenger.of(context).showSnackBar(
                        SnackBar(
                          content: Text(
                            'Error al actualizar la siembra: $error',
                          ),
                          backgroundColor: Colors.red,
                        ),
                      );
      ...
      body: _loading
          ...
          : ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                final totalMuertes =
                    (siembra['muertes_siembra'] as List?)?.fold<int>(
                      0,
                      (sum, muerte) => sum + (muerte['cantidad'] as int),
                    ) ??
                    0;
                final cantidadActual =
                    siembra['cantidad_inicial'] - totalMuertes;
